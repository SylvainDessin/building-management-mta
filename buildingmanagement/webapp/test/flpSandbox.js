		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#fioriChickenFarmbuildingmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioriChickenFarmbuildingmanagement-display": {
								"semanticObject": "fioriChickenFarmbuildingmanagement",
								"action": "display",
								"description": "Application to manage and monitor buildings",
								"title": "Building management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioriChickenFarm.buildingmanagement",
									"url": sap.ui.require.toUrl("fioriChickenFarm/buildingmanagement")
								}
							}
						}
					}
